...
const start = async () => {
  ...
  renderEvidence();renderGateA();renderGateB();renderRobustness();renderGateC();renderGateD();renderGateE();renderGateF();renderMap0();renderMap1();renderMap2();renderMechanismM0();renderMechanismM1();renderMechanismM2C();renderStructuralDiagnostic();renderStructuralTimescale();renderStructuralGroup();renderRepresentationCapacity();renderRuleFormation();renderReachability();renderReachabilityEnvelope();drawCurve();selectTrace();requestAnimationFrame(animate);
};
